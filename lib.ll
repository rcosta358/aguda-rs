...
$"??_C@_05NMOJJLIN@unit?6?$AA@" = comdat any

$"??_C@_0BC@FLDALPOG@division?5by?5zero?6?$AA@" = comdat any
...
@"??_C@_05NMOJJLIN@unit?6?$AA@" = linkonce_odr dso_local unnamed_addr constant [6 x i8] c"unit\0A\00", comdat, align 1
@"??_C@_0BC@FLDALPOG@division?5by?5zero?6?$AA@" = linkonce_odr dso_local unnamed_addr constant [18 x i8] c"division by zero\0A\00", comdat, align 1
...
define dso_local void @__print_bool__(i32 noundef %0) #0 {
  ...
  %4 = icmp ne i32 %3, 0
  %5 = zext i1 %4 to i64
  %6 = select i1 %4, ptr @"??_C@_05LFIOBDML@true?6?$AA@", ptr @"??_C@_06NIOGPBNO@false?6?$AA@"
...
define dso_local void @__print_unit__() #0 {
  %1 = call i32 (ptr, ...) @printf(ptr noundef @"??_C@_05NMOJJLIN@unit?6?$AA@")
  ret void
}
...
7:                                                ; preds = %2
  %8 = call i32 @write(i32 noundef 2, ptr noundef @"??_C@_0BC@FLDALPOG@division?5by?5zero?6?$AA@", i32 noundef 17)
