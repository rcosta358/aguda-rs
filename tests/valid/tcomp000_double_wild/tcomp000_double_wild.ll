; ModuleID = './tests/valid/tcomp000_double_wild/tcomp000_double_wild.agu'
source_filename = "./tests/valid/tcomp000_double_wild/tcomp000_double_wild.agu"
...
define i32 @main({} %0) {
entry:
  %call = call i32 @f({} zeroinitializer, i32 13)
  %call1 = call i32 @f({} zeroinitializer, i32 13)
