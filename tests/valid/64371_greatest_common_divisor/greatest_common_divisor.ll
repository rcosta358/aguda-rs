; ModuleID = './tests/valid/64371_greatest_common_divisor/greatest_common_divisor.agu'
source_filename = "./tests/valid/64371_greatest_common_divisor/greatest_common_divisor.agu"
...
then:                                             ; preds = %entry
  ...
  %mod = srem i32 %a4, %b5
  %call = call i32 @gcd(i32 %b3, i32 %mod)
  br label %merge

merge:                                            ; preds = %else, %then
  %phi = phi i32 [ %a2, %then ], [ %call, %else ]
  ret i32 %phi
}
