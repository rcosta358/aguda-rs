; ModuleID = './tests/valid/58166_modTest/modTest.agu'
source_filename = "./tests/valid/58166_modTest/modTest.agu"
...
entry:
  ...
  store i32 253540, ptr %a, align 4
  %b = alloca i32, align 4
  store i32 27, ptr %b, align 4
  %c = alloca i32, align 4
  store i32 2025, ptr %c, align 4
  %d = alloca i32, align 4
  store i32 2077, ptr %d, align 4
  %k = alloca i32, align 4
  store i32 5, ptr %k, align 4
  %a1 = load i32, ptr %a, align 4
  %k2 = load i32, ptr %k, align 4
  %call = call i1 @modTest(i32 %a1, i32 %k2)
  %a3 = load i32, ptr %a, align 4
  %k4 = load i32, ptr %k, align 4
  %call5 = call i1 @modTest(i32 %a3, i32 %k4)
  call void @__print_bool__(i1 %call5)
  %b6 = load i32, ptr %b, align 4
  %k7 = load i32, ptr %k, align 4
  %call8 = call i1 @modTest(i32 %b6, i32 %k7)
  %b9 = load i32, ptr %b, align 4
  %k10 = load i32, ptr %k, align 4
  %call11 = call i1 @modTest(i32 %b9, i32 %k10)
  call void @__print_bool__(i1 %call11)
  %c12 = load i32, ptr %c, align 4
  %k13 = load i32, ptr %k, align 4
  %call14 = call i1 @modTest(i32 %c12, i32 %k13)
  %c15 = load i32, ptr %c, align 4
  %k16 = load i32, ptr %k, align 4
  %call17 = call i1 @modTest(i32 %c15, i32 %k16)
  call void @__print_bool__(i1 %call17)
  %d18 = load i32, ptr %d, align 4
  %k19 = load i32, ptr %k, align 4
  %call20 = call i1 @modTest(i32 %d18, i32 %k19)
  %d21 = load i32, ptr %d, align 4
  %k22 = load i32, ptr %k, align 4
  %call23 = call i1 @modTest(i32 %d21, i32 %k22)
  call void @__print_bool__(i1 %call23)
  ret i32 0
}
