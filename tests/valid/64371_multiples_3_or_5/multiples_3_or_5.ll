; ModuleID = './tests/valid/64371_multiples_3_or_5/multiples_3_or_5.agu'
source_filename = "./tests/valid/64371_multiples_3_or_5/multiples_3_or_5.agu"
...
body:                                             ; preds = %cond
  ...
  %not = xor i1 %eq, true
  br i1 %not, label %rhs, label %merge3

after:                                            ; preds = %cond
  %res11 = load i32, ptr %res, align 4
  %res12 = load i32, ptr %res, align 4
  call void @__print_int__(i32 %res12)
  ret i32 0
...
rhs:                                              ; preds = %body
  ...
  %mod5 = srem i32 %i4, 5
  %eq6 = icmp eq i32 %mod5, 0
  br label %merge3

merge3:                                           ; preds = %rhs, %body
  %logical_op = phi i1 [ %eq, %body ], [ %eq6, %rhs ]
  %if_cond = icmp ne i1 %logical_op, false
