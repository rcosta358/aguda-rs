; ModuleID = './tests/valid/56311_while_loop_with_mutations/while_loop_with_mutations.agu'
source_filename = "./tests/valid/56311_while_loop_with_mutations/while_loop_with_mutations.agu"
...
body:                                             ; preds = %cond
  ...
  call void @__print_int__(i32 %n3)
