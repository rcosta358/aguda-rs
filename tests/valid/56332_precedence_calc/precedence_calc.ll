; ModuleID = './tests/valid/56332_precedence_calc/precedence_calc.agu'
source_filename = "./tests/valid/56332_precedence_calc/precedence_calc.agu"
...
entry:
  ...
  %mul = mul i32 3, %pow
  %add = add i32 12, %mul
  %pow1 = call i32 @__pow__(i32 4, i32 2)
  %mul2 = mul i32 3, %pow1
  %add3 = add i32 12, %mul2
  call void @__print_int__(i32 %add3)
  ret i32 0
}
