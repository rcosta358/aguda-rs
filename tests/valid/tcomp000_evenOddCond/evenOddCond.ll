; ModuleID = './tests/valid/tcomp000_evenOddCond/evenOddCond.agu'
source_filename = "./tests/valid/tcomp000_evenOddCond/evenOddCond.agu"
...
merge:                                            ; preds = %else, %then
  %phi = phi i1 [ true, %then ], [ %call, %else ]
  ret i1 %phi
}
...
merge:                                            ; preds = %else, %then
  %phi = phi i1 [ %call, %then ], [ false, %else ]
  ret i1 %phi
}
