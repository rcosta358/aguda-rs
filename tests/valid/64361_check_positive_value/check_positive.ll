; ModuleID = './tests/valid/64361_check_positive_value/check_positive.agu'
source_filename = "./tests/valid/64361_check_positive_value/check_positive.agu"
...
define void @testPositiveAssignment(i32 %0) {
entry:
