; ModuleID = './tests/valid/58185_boolean_logic/boolean_logic.agu'
source_filename = "./tests/valid/58185_boolean_logic/boolean_logic.agu"
...
entry:
  ...
  %if_cond = icmp ne i1 %b1, false
  br i1 %if_cond, label %then, label %else

then:                                             ; preds = %entry
  call void @__print_bool__(i1 true)
  br label %merge

else:                                             ; preds = %entry
  call void @__print_bool__(i1 false)
  br label %merge
...
define i32 @main({} %0) {
entry:
  br i1 true, label %rhs, label %merge

rhs:                                              ; preds = %entry
  br label %merge

merge:                                            ; preds = %rhs, %entry
  %logical_op = phi i1 [ true, %entry ], [ true, %rhs ]
  call void @printBool(i1 %logical_op)
  br i1 true, label %rhs1, label %merge2

rhs1:                                             ; preds = %merge
  br label %merge2

merge2:                                           ; preds = %rhs1, %merge
  %logical_op3 = phi i1 [ true, %merge ], [ false, %rhs1 ]
  call void @printBool(i1 %logical_op3)
  br i1 false, label %rhs4, label %merge5

rhs4:                                             ; preds = %merge2
  br label %merge5

merge5:                                           ; preds = %rhs4, %merge2
  %logical_op6 = phi i1 [ true, %merge2 ], [ false, %rhs4 ]
  call void @printBool(i1 %logical_op6)
  br i1 true, label %rhs7, label %merge8

rhs7:                                             ; preds = %merge5
  br label %merge8

merge8:                                           ; preds = %rhs7, %merge5
  %logical_op9 = phi i1 [ false, %merge5 ], [ false, %rhs7 ]
  call void @printBool(i1 %logical_op9)
