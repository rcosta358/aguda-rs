; ModuleID = './tests/valid/58170_pyramid/pyramid.agu'
source_filename = "./tests/valid/58170_pyramid/pyramid.agu"
...
define void @printPyramid(i32 %0) {
entry:
...
cond:                                             ; preds = %after14, %entry
  %i1 = load i32, ptr %i, align 4
  %rows2 = load i32, ptr %rows, align 4
  %leq = icmp sle i32 %i1, %rows2
...
body:                                             ; preds = %cond
  ...
  %rows3 = load i32, ptr %rows, align 4
  %i4 = load i32, ptr %i, align 4
  %sub = sub i32 %rows3, %i4
...
cond5:                                            ; preds = %body6, %body
  %space8 = load i32, ptr %space, align 4
  %gt = icmp sgt i32 %space8, 0
  %while_cond9 = icmp ne i1 %gt, false
  br i1 %while_cond9, label %body6, label %after7

body6:                                            ; preds = %cond5
  call void @__print_int__(i32 0)
  %space10 = load i32, ptr %space, align 4
  %sub11 = sub i32 %space10, 1
  store i32 %sub11, ptr %space, align 4
  br label %cond5

after7:                                           ; preds = %cond5
  br label %cond12

cond12:                                           ; preds = %body13, %after7
  %j15 = load i32, ptr %j, align 4
  %i16 = load i32, ptr %i, align 4
  %mul = mul i32 2, %i16
  %sub17 = sub i32 %mul, 1
  %leq18 = icmp sle i32 %j15, %sub17
  %while_cond19 = icmp ne i1 %leq18, false
  br i1 %while_cond19, label %body13, label %after14

body13:                                           ; preds = %cond12
  call void @__print_int__(i32 1)
  %j20 = load i32, ptr %j, align 4
  %add = add i32 %j20, 1
  store i32 %add, ptr %j, align 4
  br label %cond12

after14:                                          ; preds = %cond12
  call void @__print_int__(i32 9)
