; ModuleID = './tests/valid/56307_shadowingFunction/shadowFunction.agu'
source_filename = "./tests/valid/56307_shadowingFunction/shadowFunction.agu"
...
define i32 @main({} %0) {
entry:
  %call = call i32 @shadowTest(i32 5)
  %call1 = call i32 @shadowTest(i32 5)
