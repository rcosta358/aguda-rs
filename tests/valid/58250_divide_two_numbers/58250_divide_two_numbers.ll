; ModuleID = './tests/valid/58250_divide_two_numbers/58250_divide_two_numbers.agu'
source_filename = "./tests/valid/58250_divide_two_numbers/58250_divide_two_numbers.agu"
...
entry:
  ...
  %div = call i32 @__div__(i32 %a1, i32 %b2)
  ret i32 %div
}
