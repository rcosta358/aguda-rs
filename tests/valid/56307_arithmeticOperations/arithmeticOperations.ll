; ModuleID = './tests/valid/56307_arithmeticOperations/arithmeticOperations.agu'
source_filename = "./tests/valid/56307_arithmeticOperations/arithmeticOperations.agu"
...
define i32 @combine(i32 %0, i32 %1) {
entry:
  %n = alloca i32, align 4
  store i32 %0, ptr %n, align 4
  ...
  %call = call i32 @sumUp(i32 %n1)
  %s = alloca i32, align 4
  store i32 %call, ptr %s, align 4
  %n2 = load i32, ptr %n, align 4
  %m3 = load i32, ptr %m, align 4
  %call4 = call i32 @product(i32 %n2, i32 %m3)
...
define i32 @main({} %0) {
entry:
  %call = call i32 @combine(i32 10, i32 5)
  %call1 = call i32 @combine(i32 10, i32 5)
