; ModuleID = './tests/valid/58182_nested_function_calls/nested_function_calls.agu'
source_filename = "./tests/valid/58182_nested_function_calls/nested_function_calls.agu"
...
define i32 @addTwo(i32 %0) {
entry:
  %x = alloca i32, align 4
  store i32 %0, ptr %x, align 4
  %x1 = load i32, ptr %x, align 4
  %call = call i32 @addOne(i32 %x1)
  %call2 = call i32 @addOne(i32 %call)
  ret i32 %call2
}

define i32 @main({} %0) {
entry:
  %call = call i32 @addTwo(i32 5)
  %result = alloca i32, align 4
  store i32 %call, ptr %result, align 4
  %result1 = load i32, ptr %result, align 4
  %result2 = load i32, ptr %result, align 4
  call void @__print_int__(i32 %result2)
  ret i32 0
}
