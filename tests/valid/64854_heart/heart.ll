; ModuleID = './tests/valid/64854_heart/heart.agu'
source_filename = "./tests/valid/64854_heart/heart.agu"
...
define void @giantHeart({} %0) {
entry:
  %heart = alloca i32, align 4
  store i32 17034604, ptr %heart, align 4
...
cond:                                             ; preds = %body, %entry
  ...
  %lt = icmp slt i32 %i1, 1
  %while_cond = icmp ne i1 %lt, false
  br i1 %while_cond, label %body, label %after

body:                                             ; preds = %cond
  %heart2 = load i32, ptr %heart, align 4
  %heart3 = load i32, ptr %heart, align 4
  call void @__print_int__(i32 %heart3)
...
define i32 @main({} %0) {
entry:
  call void @giantHeart({} zeroinitializer)
  ret i32 0
}
