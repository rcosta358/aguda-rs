; ModuleID = './tests/valid/58185_unit_type_test/unit_type_test.agu'
source_filename = "./tests/valid/58185_unit_type_test/unit_type_test.agu"
...
define void @storeWhile(i32 %0) {
entry:
  %n = alloca i32, align 4
  store i32 %0, ptr %n, align 4
  %n1 = load i32, ptr %n, align 4
  %i = alloca i32, align 4
  store i32 %n1, ptr %i, align 4
  br label %cond

cond:                                             ; preds = %body, %entry
  %i2 = load i32, ptr %i, align 4
  %gt = icmp sgt i32 %i2, 0
...
body:                                             ; preds = %cond
  ...
  call void @__print_int__(i32 %i4)
