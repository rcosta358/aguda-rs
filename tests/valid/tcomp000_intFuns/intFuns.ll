; ModuleID = './tests/valid/tcomp000_intFuns/intFuns.agu'
source_filename = "./tests/valid/tcomp000_intFuns/intFuns.agu"
...
entry:
  ...
  %call = call i32 @mul(i32 %x2, i32 %x3)
  %call4 = call i32 @add(i32 %x1, i32 %call)
  ret i32 %call4
}
