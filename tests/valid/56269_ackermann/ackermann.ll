; ModuleID = './tests/valid/56269_ackermann/ackermann.agu'
source_filename = "./tests/valid/56269_ackermann/ackermann.agu"
...
else4:                                            ; preds = %else
  ...
  %sub14 = sub i32 %n13, 1
  %call15 = call i32 @ack(i32 %m12, i32 %sub14)
  %call16 = call i32 @ack(i32 %sub11, i32 %call15)
  br label %merge5

merge5:                                           ; preds = %else4, %then3
  %phi = phi i32 [ %call, %then3 ], [ %call16, %else4 ]
  br label %merge
}

define i32 @main({} %0) {
entry:
  %call = call i32 @ack(i32 2, i32 3)
  %call1 = call i32 @ack(i32 2, i32 3)
