; ModuleID = './tests/valid/64854_is_pair/is_pair.agu'
source_filename = "./tests/valid/64854_is_pair/is_pair.agu"
...
define i32 @main({} %0) {
entry:
  %call = call i1 @isPair(i32 4)
  %call1 = call i1 @isPair(i32 4)
