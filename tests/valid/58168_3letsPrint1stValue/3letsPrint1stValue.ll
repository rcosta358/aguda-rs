; ModuleID = './tests/valid/58168_3letsPrint1stValue/3letsPrint1stValue.agu'
source_filename = "./tests/valid/58168_3letsPrint1stValue/3letsPrint1stValue.agu"
...
entry:
  ...
  call void @__print_int__(i32 %a2)
  ret i32 0
}
