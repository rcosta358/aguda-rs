; ModuleID = './tests/valid/58250_cube/58250_cube.agu'
source_filename = "./tests/valid/58250_cube/58250_cube.agu"
...
entry:
  %call = call i32 @cube(i32 5)
  ret i32 %call
}

define i32 @main({} %0) {
entry:
  %call = call i32 @final_result({} zeroinitializer)
  %call1 = call i32 @final_result({} zeroinitializer)
