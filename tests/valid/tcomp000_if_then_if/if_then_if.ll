; ModuleID = './tests/valid/tcomp000_if_then_if/if_then_if.agu'
source_filename = "./tests/valid/tcomp000_if_then_if/if_then_if.agu"
...
merge:                                            ; preds = %else, %merge3
  %phi4 = phi {} [ %phi, %merge3 ], [ zeroinitializer, %else ]
...
merge3:                                           ; preds = %else2, %then1
  %phi = phi {} [ zeroinitializer, %then1 ], [ zeroinitializer, %else2 ]
  br label %merge
...
merge7:                                           ; preds = %else6, %merge10
  %phi12 = phi {} [ %phi11, %merge10 ], [ zeroinitializer, %else6 ]
  call void @__print_unit__({} %phi12)
  ret i32 0
...
merge10:                                          ; preds = %else9, %then8
  %phi11 = phi {} [ zeroinitializer, %then8 ], [ zeroinitializer, %else9 ]
  br label %merge7
}
