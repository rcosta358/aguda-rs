; ModuleID = './tests/valid/56311_while_loop_with_empty_body/while_loop_with_empty_body.agu'
source_filename = "./tests/valid/56311_while_loop_with_empty_body/while_loop_with_empty_body.agu"
...
define void @countForever(i32 %0) {
entry:
...
body:                                             ; preds = %cond
  ...
  call void @__print_int__(i32 %n2)
  br label %cond
