; ModuleID = './tests/valid/56334_fibonacci/fibonacci.agu'
source_filename = "./tests/valid/56334_fibonacci/fibonacci.agu"
...
else3:                                            ; preds = %else
  ...
  %sub10 = sub i32 %n9, 2
  %call11 = call i32 @Fibonacci(i32 %sub10)
...
define i32 @main({} %0) {
entry:
  %call = call i32 @Fibonacci(i32 20)
  %call1 = call i32 @Fibonacci(i32 20)
