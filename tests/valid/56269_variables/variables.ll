; ModuleID = './tests/valid/56269_variables/variables.agu'
source_filename = "./tests/valid/56269_variables/variables.agu"
...
entry:
  ...
  %mul6 = mul i32 %mul4, %x5
  ret i32 %mul6
}

define i32 @main({} %0) {
entry:
  %call = call i32 @f({} zeroinitializer)
  %call1 = call i32 @f({} zeroinitializer)
