; ModuleID = './tests/valid/58168_incrementor/incrementor.agu'
source_filename = "./tests/valid/58168_incrementor/incrementor.agu"
...
define i32 @main({} %0) {
entry:
  %call = call i32 @inc(i32 4)
  %call1 = call i32 @inc(i32 4)
