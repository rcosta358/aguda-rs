; ModuleID = './tests/valid/58185_while_loops/while_loops.agu'
source_filename = "./tests/valid/58185_while_loops/while_loops.agu"
...
define void @printPattern(i32 %0) {
entry:
...
cond3:                                            ; preds = %body4, %body
  ...
  %leq = icmp sle i32 %j6, %i7
  %while_cond8 = icmp ne i1 %leq, false
  br i1 %while_cond8, label %body4, label %after5
