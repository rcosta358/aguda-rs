; ModuleID = './tests/valid/54394_semicolon_assignment/semicolon_assignment.agu'
source_filename = "./tests/valid/54394_semicolon_assignment/semicolon_assignment.agu"
...
after:                                            ; preds = %cond
  ...
  call void @__print_int__(i32 %y4)
  ret i32 0
}
