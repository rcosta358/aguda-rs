; ModuleID = './tests/valid/64361_factorial/factorial.agu'
source_filename = "./tests/valid/64361_factorial/factorial.agu"
...
define i32 @main({} %0) {
entry:
  %call = call i32 @fact(i32 5)
  %call1 = call i32 @fact(i32 5)
  call void @__print_int__(i32 %call1)
  %call2 = call i32 @fact(i32 0)
  %call3 = call i32 @fact(i32 0)
  call void @__print_int__(i32 %call3)
  %call4 = call i32 @fact(i32 7)
  %call5 = call i32 @fact(i32 7)
