; ModuleID = './tests/valid/58185_simple_arithmetic/simple_arithmetic.agu'
source_filename = "./tests/valid/58185_simple_arithmetic/simple_arithmetic.agu"
...
define i32 @main({} %0) {
entry:
  call void @__print_int__(i32 15)
  call void @__print_int__(i32 5)
  call void @__print_int__(i32 50)
  %div = call i32 @__div__(i32 10, i32 5)
  %div1 = call i32 @__div__(i32 10, i32 5)
  call void @__print_int__(i32 %div1)
