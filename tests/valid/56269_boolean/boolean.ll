; ModuleID = './tests/valid/56269_boolean/boolean.agu'
source_filename = "./tests/valid/56269_boolean/boolean.agu"
...
merge3:                                           ; preds = %else2, %then1
  %phi4 = phi i1 [ true, %then1 ], [ false, %else2 ]
  call void @__print_bool__(i1 %phi4)
  ret i32 0
}
