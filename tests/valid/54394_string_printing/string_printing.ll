; ModuleID = './tests/valid/54394_string_printing/string_printing.agu'
source_filename = "./tests/valid/54394_string_printing/string_printing.agu"
...
define void @printn(i1 %0, i32 %1) {
entry:
  %s = alloca i1, align 1
  store i1 %0, ptr %s, align 1
...
body:                                             ; preds = %cond
  %s3 = load i1, ptr %s, align 1
  %s4 = load i1, ptr %s, align 1
  call void @__print_bool__(i1 %s4)
...
define i32 @main({} %0) {
entry:
  call void @printn(i1 false, i32 4)
  ret i32 0
}
