; ModuleID = './tests/valid/tcomp000-scope-cond/tcomp000-scope-cond.agu'
source_filename = "./tests/valid/tcomp000-scope-cond/tcomp000-scope-cond.agu"
...
merge:                                            ; preds = %else, %then
  %phi = phi i32 [ %x1, %then ], [ 6, %else ]
  %x3 = alloca i32, align 4
  store i32 %phi, ptr %x3, align 4
  %x4 = load i32, ptr %x3, align 4
  %x5 = load i32, ptr %x3, align 4
  call void @__print_int__(i32 %x5)
  ret i32 0
}
