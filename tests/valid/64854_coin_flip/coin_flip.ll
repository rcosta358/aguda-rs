; ModuleID = './tests/valid/64854_coin_flip/coin_flip.agu'
source_filename = "./tests/valid/64854_coin_flip/coin_flip.agu"
...
define i32 @coinFlip(i32 %0) {
entry:
  %n = alloca i32, align 4
  store i32 %0, ptr %n, align 4
  %n1 = load i32, ptr %n, align 4
  %mod = srem i32 %n1, 2
  %eq = icmp eq i32 %mod, 1
...
define i32 @main({} %0) {
entry:
  %call = call i32 @coinFlip(i32 4)
  %call1 = call i32 @coinFlip(i32 4)
