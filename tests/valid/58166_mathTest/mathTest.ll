; ModuleID = './tests/valid/58166_mathTest/mathTest.agu'
source_filename = "./tests/valid/58166_mathTest/mathTest.agu"
...
define i32 @main({} %0) {
entry:
  %call = call i1 @mathTest({} zeroinitializer)
  %call1 = call i1 @mathTest({} zeroinitializer)
