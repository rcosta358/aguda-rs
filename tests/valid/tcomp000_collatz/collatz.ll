; ModuleID = './tests/valid/tcomp000_collatz/collatz.agu'
source_filename = "./tests/valid/tcomp000_collatz/collatz.agu"
...
then:                                             ; preds = %entry
  ...
  %div = call i32 @__div__(i32 %n2, i32 2)
  br label %merge
...
merge:                                            ; preds = %else, %then
  %phi = phi i32 [ %div, %then ], [ %add, %else ]
  ret i32 %phi
}

define void @conjecture(i32 %0) {
entry:
  %n = alloca i32, align 4
  store i32 %0, ptr %n, align 4
  %n1 = load i32, ptr %n, align 4
  %call = call i32 @f(i32 %n1)
  %neq = icmp ne i32 %call, 0
