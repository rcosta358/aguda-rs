; ModuleID = './tests/valid/58170_opWithoutParen/opWithoutParen.agu'
source_filename = "./tests/valid/58170_opWithoutParen/opWithoutParen.agu"
...
define i32 @main({} %0) {
entry:
  %pow = call i32 @__pow__(i32 4, i32 2)
  %mul = mul i32 3, %pow
  %div = call i32 @__div__(i32 %mul, i32 2)
  %add = add i32 2, %div
  %sub = sub i32 %add, 1
  %a = alloca i32, align 4
  store i32 %sub, ptr %a, align 4
  %pow1 = call i32 @__pow__(i32 -2, i32 2)
  %mul2 = mul i32 3, %pow1
...
rhs:                                              ; preds = %entry
  br i1 false, label %rhs3, label %merge4

merge:                                            ; preds = %merge4, %entry
  %logical_op5 = phi i1 [ false, %entry ], [ %logical_op, %merge4 ]
  %c = alloca i1, align 1
  store i1 %logical_op5, ptr %c, align 1
  %a6 = load i32, ptr %a, align 4
  %a7 = load i32, ptr %a, align 4
  call void @__print_int__(i32 %a7)
  %b8 = load i32, ptr %b, align 4
  %b9 = load i32, ptr %b, align 4
  call void @__print_int__(i32 %b9)
  %c10 = load i1, ptr %c, align 1
  %c11 = load i1, ptr %c, align 1
  call void @__print_bool__(i1 %c11)
  ret i32 0
...
merge4:                                           ; preds = %rhs3, %rhs
  %logical_op = phi i1 [ false, %rhs ], [ true, %rhs3 ]
  br label %merge
}
