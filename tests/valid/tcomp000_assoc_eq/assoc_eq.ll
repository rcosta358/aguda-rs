; ModuleID = './tests/valid/tcomp000_assoc_eq/assoc_eq.agu'
source_filename = "./tests/valid/tcomp000_assoc_eq/assoc_eq.agu"
...
merge:                                            ; preds = %rhs, %entry
  ...
  %eq2 = icmp eq i1 %eq, %logical_op
  %b3 = load i1, ptr %b, align 1
  %eq4 = icmp eq i1 true, %b3
  br i1 true, label %rhs5, label %merge6

rhs5:                                             ; preds = %merge
  br label %merge6

merge6:                                           ; preds = %rhs5, %merge
  %logical_op7 = phi i1 [ false, %merge ], [ true, %rhs5 ]
  %eq8 = icmp eq i1 %eq4, %logical_op7
  call void @__print_bool__(i1 %eq8)
  ret i32 0
}
