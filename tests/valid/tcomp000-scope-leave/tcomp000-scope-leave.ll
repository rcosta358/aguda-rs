; ModuleID = './tests/valid/tcomp000-scope-leave/tcomp000-scope-leave.agu'
source_filename = "./tests/valid/tcomp000-scope-leave/tcomp000-scope-leave.agu"
...
entry:
  ...
  store i1 true, ptr %x1, align 1
  %x2 = load i32, ptr %x, align 4
  %x3 = load i32, ptr %x, align 4
  call void @__print_int__(i32 %x3)
  ret i32 0
}
