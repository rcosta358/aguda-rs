; ModuleID = './tests/valid/58250_sum_all_to_n/58250_sum_all_to_n.agu'
source_filename = "./tests/valid/58250_sum_all_to_n/58250_sum_all_to_n.agu"
...
define i32 @result({} %0) {
entry:
  %call = call i32 @sum_up_to_n(i32 8127)
  ret i32 %call
}

define i32 @main({} %0) {
entry:
  %call = call i32 @result({} zeroinitializer)
  %call1 = call i32 @result({} zeroinitializer)
