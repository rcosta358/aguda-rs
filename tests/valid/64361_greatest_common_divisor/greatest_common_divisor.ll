; ModuleID = './tests/valid/64361_greatest_common_divisor/greatest_common_divisor.agu'
source_filename = "./tests/valid/64361_greatest_common_divisor/greatest_common_divisor.agu"
...
cond:                                             ; preds = %body, %entry
  ...
  %neq = icmp ne i32 %b1, 0
  %while_cond = icmp ne i1 %neq, false
  br i1 %while_cond, label %body, label %after

body:                                             ; preds = %cond
  %b2 = load i32, ptr %b, align 4
  %temp = alloca i32, align 4
  store i32 %b2, ptr %temp, align 4
  %a3 = load i32, ptr %a, align 4
  %b4 = load i32, ptr %b, align 4
  %mod = srem i32 %a3, %b4
  store i32 %mod, ptr %b, align 4
  %temp5 = load i32, ptr %temp, align 4
  store i32 %temp5, ptr %a, align 4
  br label %cond
...
define i32 @main({} %0) {
entry:
  %call = call i32 @mdc(i32 48, i32 18)
  %call1 = call i32 @mdc(i32 48, i32 18)
  call void @__print_int__(i32 %call1)
  %call2 = call i32 @mdc(i32 101, i32 103)
  %call3 = call i32 @mdc(i32 101, i32 103)
  call void @__print_int__(i32 %call3)
  %call4 = call i32 @mdc(i32 56, i32 98)
  %call5 = call i32 @mdc(i32 56, i32 98)
