; ModuleID = './tests/valid/56332_simple_sum/simple_sum.agu'
source_filename = "./tests/valid/56332_simple_sum/simple_sum.agu"
...
define i32 @main({} %0) {
entry:
  %call = call i32 @sum(i32 10, i32 5)
  %call1 = call i32 @sum(i32 10, i32 5)
