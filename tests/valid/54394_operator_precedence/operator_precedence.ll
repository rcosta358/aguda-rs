; ModuleID = './tests/valid/54394_operator_precedence/operator_precedence.agu'
source_filename = "./tests/valid/54394_operator_precedence/operator_precedence.agu"
...
entry:
  ...
  %add = add i32 %sub, 11
  %mod = srem i32 %add, 5
  %div = call i32 @__div__(i32 6, i32 -3)
  %add1 = add i32 %mod, %div
  %pow2 = call i32 @__pow__(i32 2, i32 3)
  %sub3 = sub i32 10, %pow2
  %add4 = add i32 %sub3, 11
  %mod5 = srem i32 %add4, 5
  %div6 = call i32 @__div__(i32 6, i32 -3)
  %add7 = add i32 %mod5, %div6
  call void @__print_int__(i32 %add7)
  ret i32 0
}
