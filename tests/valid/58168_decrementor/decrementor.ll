; ModuleID = './tests/valid/58168_decrementor/decrementor.agu'
source_filename = "./tests/valid/58168_decrementor/decrementor.agu"
...
define i32 @main({} %0) {
entry:
  %call = call i32 @denc(i32 6)
  %call1 = call i32 @denc(i32 6)
