; ModuleID = './tests/valid/58168_minusTwoNumbers/minusTwoNumbers.agu'
source_filename = "./tests/valid/58168_minusTwoNumbers/minusTwoNumbers.agu"
...
define i32 @main({} %0) {
entry:
  %call = call i32 @minus(i32 5, i32 4)
  %call1 = call i32 @minus(i32 5, i32 4)
