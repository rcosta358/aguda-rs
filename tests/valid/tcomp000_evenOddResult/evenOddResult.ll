; ModuleID = './tests/valid/tcomp000_evenOddResult/evenOddResult.agu'
source_filename = "./tests/valid/tcomp000_evenOddResult/evenOddResult.agu"
...
then:                                             ; preds = %entry
  ...
  store i1 %call, ptr %result, align 1
  br label %merge

merge:                                            ; preds = %else, %then
  %phi = phi {} [ zeroinitializer, %then ], [ zeroinitializer, %else ]
  %result3 = load i1, ptr %result, align 1
  ret i1 %result3
}
...
entry:
  ...
  %call = call i1 @odd(i32 19)
  %call1 = call i1 @odd(i32 19)
