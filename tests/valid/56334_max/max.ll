; ModuleID = './tests/valid/56334_max/max.agu'
source_filename = "./tests/valid/56334_max/max.agu"
...
merge:                                            ; preds = %else, %then
  %phi = phi i32 [ %x3, %then ], [ %y4, %else ]
  ret i32 %phi
}

define i32 @main({} %0) {
entry:
  %call = call i32 @max(i32 5, i32 9)
  %call1 = call i32 @max(i32 5, i32 9)
