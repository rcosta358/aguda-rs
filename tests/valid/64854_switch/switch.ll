; ModuleID = './tests/valid/64854_switch/switch.agu'
source_filename = "./tests/valid/64854_switch/switch.agu"
...
define i1 @switch(i1 %0) {
entry:
  %boolean = alloca i1, align 1
  store i1 %0, ptr %boolean, align 1
  %boolean1 = load i1, ptr %boolean, align 1
  %not = xor i1 %boolean1, true
  ret i1 %not
}

define i32 @main({} %0) {
entry:
  %call = call i1 @switch(i1 true)
  %call1 = call i1 @switch(i1 true)
