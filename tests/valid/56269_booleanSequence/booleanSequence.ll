; ModuleID = './tests/valid/56269_booleanSequence/booleanSequence.agu'
source_filename = "./tests/valid/56269_booleanSequence/booleanSequence.agu"
...
define i32 @main({} %0) {
entry:
  br i1 false, label %rhs, label %merge

rhs:                                              ; preds = %entry
  br label %merge

merge:                                            ; preds = %rhs, %entry
  %logical_op = phi i1 [ false, %entry ], [ true, %rhs ]
  %not = xor i1 %logical_op, true
  br i1 %not, label %rhs1, label %merge2

rhs1:                                             ; preds = %merge
  br label %merge2

merge2:                                           ; preds = %rhs1, %merge
  %logical_op3 = phi i1 [ %logical_op, %merge ], [ true, %rhs1 ]
...
merge5:                                           ; preds = %rhs4, %merge2
  %logical_op6 = phi i1 [ false, %merge2 ], [ true, %rhs4 ]
  %not9 = xor i1 %logical_op6, true
...
merge8:                                           ; preds = %rhs7, %merge5
  %logical_op10 = phi i1 [ %logical_op6, %merge5 ], [ true, %rhs7 ]
  call void @__print_bool__(i1 %logical_op10)
  ret i32 0
}
