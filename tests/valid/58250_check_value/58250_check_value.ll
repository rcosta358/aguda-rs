; ModuleID = './tests/valid/58250_check_value/58250_check_value.agu'
source_filename = "./tests/valid/58250_check_value/58250_check_value.agu"
...
define i1 @result({} %0) {
entry:
  %call = call i1 @check_sign(i32 -5)
  ret i1 %call
}

define i32 @main({} %0) {
entry:
  %call = call i1 @result({} zeroinitializer)
  %call1 = call i1 @result({} zeroinitializer)
