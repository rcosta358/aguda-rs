; ModuleID = './tests/valid/58250_calculate_operations/58250_calculate_operations.agu'
source_filename = "./tests/valid/58250_calculate_operations/58250_calculate_operations.agu"
...
define i32 @calculate_operations(i32 %0, i32 %1, i32 %2, i32 %3, i32 %4) {
entry:
  ...
  %mul = mul i32 %a1, %b2
  %mult1 = alloca i32, align 4
  store i32 %mul, ptr %mult1, align 4
  %c3 = load i32, ptr %c, align 4
  %d4 = load i32, ptr %d, align 4
  %mul5 = mul i32 %c3, %d4
  %mult2 = alloca i32, align 4
  store i32 %mul5, ptr %mult2, align 4
  %mult16 = load i32, ptr %mult1, align 4
  %mult27 = load i32, ptr %mult2, align 4
  %sub = sub i32 %mult16, %mult27
  %sub1 = alloca i32, align 4
  store i32 %sub, ptr %sub1, align 4
  %sub18 = load i32, ptr %sub1, align 4
  %e9 = load i32, ptr %e, align 4
  %add = add i32 %sub18, %e9
...
entry:
  ...
  %call = call i32 @calculate_operations(i32 %x, i32 %y, i32 %z, i32 %w, i32 %v)
  ret i32 %call
}
...
entry:
  %x = alloca {}, align 8
  store {} %0, ptr %x, align 1
  %x1 = load {}, ptr %x, align 1
  %call = call i32 @final_result({} %x1)
  %x2 = load {}, ptr %x, align 1
  %call3 = call i32 @final_result({} %x2)
