; ModuleID = './tests/valid/54394_identifier/identifier.agu'
source_filename = "./tests/valid/54394_identifier/identifier.agu"
...
define void @weird_34NameLols_({} %0) {
entry:
  br label %cond

cond:                                             ; preds = %body, %entry
  br i1 false, label %body, label %after

body:                                             ; preds = %cond
  %this_is_a_long_name_for_some_reason = alloca i32, align 4
  store i32 987789, ptr %this_is_a_long_name_for_some_reason, align 4
  br label %cond

after:                                            ; preds = %cond
  %"len'gth________" = alloca {}, align 8
  store {} zeroinitializer, ptr %"len'gth________", align 1
  ret void
}

define i32 @main({} %0) {
entry:
  call void @weird_34NameLols_({} zeroinitializer)
  call void @weird_34NameLols_({} zeroinitializer)
  call void @__print_unit__({} zeroinitializer)
  ret i32 0
}
