; ModuleID = './tests/valid/tcomp000_power-of-power/power-of-power.agu'
source_filename = "./tests/valid/tcomp000_power-of-power/power-of-power.agu"
...
entry:
  ...
  %pow = call i32 @__pow__(i32 3, i32 2)
  %pow1 = call i32 @__pow__(i32 4, i32 %pow)
  %pow2 = call i32 @__pow__(i32 5, i32 %pow1)
  %pow3 = call i32 @__pow__(i32 3, i32 2)
  %pow4 = call i32 @__pow__(i32 4, i32 %pow3)
  %pow5 = call i32 @__pow__(i32 5, i32 %pow4)
