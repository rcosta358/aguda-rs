; ModuleID = './tests/valid/56332_if_then_else_printing_string/if_then_else_printing_string.agu'
source_filename = "./tests/valid/56332_if_then_else_printing_string/if_then_else_printing_string.agu"
...
define i1 @sinal(i32 %0) {
entry:
  %n = alloca i32, align 4
  store i32 %0, ptr %n, align 4
  %n1 = load i32, ptr %n, align 4
  %geq = icmp sge i32 %n1, 0
  ret i1 %geq
}

define i32 @main({} %0) {
entry:
  %call = call i1 @sinal(i32 0)
  %call1 = call i1 @sinal(i32 0)
