; ModuleID = './tests/valid/54394_combinations/combinations.agu'
source_filename = "./tests/valid/54394_combinations/combinations.agu"
...
merge:                                            ; preds = %else, %then
  %phi = phi i32 [ 1, %then ], [ %mul, %else ]
  ret i32 %phi
}

define i32 @comb(i32 %0, i32 %1) {
entry:
  %n = alloca i32, align 4
  store i32 %0, ptr %n, align 4
  ...
  %n1 = load i32, ptr %n, align 4
  %call = call i32 @fac(i32 %n1)
  %k2 = load i32, ptr %k, align 4
  %call3 = call i32 @fac(i32 %k2)
  %n4 = load i32, ptr %n, align 4
  %k5 = load i32, ptr %k, align 4
  %sub = sub i32 %n4, %k5
  %call6 = call i32 @fac(i32 %sub)
  %mul = mul i32 %call3, %call6
  %div = call i32 @__div__(i32 %call, i32 %mul)
  ret i32 %div
}

define i32 @main({} %0) {
entry:
  %call = call i32 @comb(i32 6, i32 2)
  %call1 = call i32 @comb(i32 6, i32 2)
