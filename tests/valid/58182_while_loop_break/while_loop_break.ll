; ModuleID = './tests/valid/58182_while_loop_break/while_loop_break.agu'
source_filename = "./tests/valid/58182_while_loop_break/while_loop_break.agu"
...
entry:
  ...
  %breakCondition = alloca i32, align 4
  store i32 5, ptr %breakCondition, align 4
...
cond:                                             ; preds = %merge4, %entry
  ...
  %lt = icmp slt i32 %i1, %limit2
  br i1 %lt, label %rhs, label %merge

body:                                             ; preds = %merge
  %i5 = load i32, ptr %i, align 4
  %breakCondition6 = load i32, ptr %breakCondition, align 4
  %eq = icmp eq i32 %i5, %breakCondition6
...
merge:                                            ; preds = %rhs, %cond
  %logical_op = phi i1 [ %lt, %cond ], [ %flag3, %rhs ]
  %while_cond = icmp ne i1 %logical_op, false
...
then:                                             ; preds = %body
  ...
  call void @__print_int__(i32 %i8)
