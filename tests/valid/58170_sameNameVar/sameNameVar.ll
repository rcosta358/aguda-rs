; ModuleID = './tests/valid/58170_sameNameVar/sameNameVar.agu'
source_filename = "./tests/valid/58170_sameNameVar/sameNameVar.agu"
...
entry:
  ...
  %x1 = load i32, ptr @x, align 4
  call void @__print_int__(i32 %x1)
  %call = call i32 @otherX({} zeroinitializer)
  %call2 = call i32 @otherX({} zeroinitializer)
  call void @__print_int__(i32 %call2)
  %x3 = load i32, ptr @x, align 4
  %x4 = load i32, ptr @x, align 4
  call void @__print_int__(i32 %x4)
  ret i32 0
}
