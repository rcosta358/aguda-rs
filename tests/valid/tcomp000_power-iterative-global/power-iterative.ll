; ModuleID = './tests/valid/tcomp000_power-iterative-global/power-iterative.agu'
source_filename = "./tests/valid/tcomp000_power-iterative-global/power-iterative.agu"
...
cond:                                             ; preds = %body, %entry
  %exponent1 = load i32, ptr %exponent, align 4
  %gt = icmp sgt i32 %exponent1, 0
  %while_cond = icmp ne i1 %gt, false
  br i1 %while_cond, label %body, label %after

body:                                             ; preds = %cond
  %result = load i32, ptr @result, align 4
  %base2 = load i32, ptr %base, align 4
  %mul = mul i32 %result, %base2
  store i32 %mul, ptr @result, align 4
  %exponent3 = load i32, ptr %exponent, align 4
  %sub = sub i32 %exponent3, 1
...
define i32 @main({} %0) {
entry:
  %call = call i32 @power(i32 2, i32 6)
  %call1 = call i32 @power(i32 2, i32 6)
