; ModuleID = './tests/valid/58166_digits/digits.agu'
source_filename = "./tests/valid/58166_digits/digits.agu"
...
merge:                                            ; preds = %else, %then
  %phi = phi i32 [ %sub, %then ], [ %n3, %else ]
  %m = alloca i32, align 4
  store i32 %phi, ptr %m, align 4
  %m7 = load i32, ptr %m, align 4
  %lt8 = icmp slt i32 %m7, 10
  %if_cond9 = icmp ne i1 %lt8, false
  br i1 %if_cond9, label %then4, label %else5
...
else5:                                            ; preds = %merge
  ...
  %div = call i32 @__div__(i32 %m10, i32 10)
  %call = call i32 @digits(i32 %div)
  %add = add i32 1, %call
  br label %merge6

merge6:                                           ; preds = %else5, %then4
  %phi11 = phi i32 [ 1, %then4 ], [ %add, %else5 ]
  ret i32 %phi11
}

define i32 @main({} %0) {
entry:
  %call = call i32 @digits(i32 2025)
  %call1 = call i32 @digits(i32 2025)
