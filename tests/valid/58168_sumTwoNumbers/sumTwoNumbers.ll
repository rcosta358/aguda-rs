; ModuleID = './tests/valid/58168_sumTwoNumbers/sumTwoNumbers.agu'
source_filename = "./tests/valid/58168_sumTwoNumbers/sumTwoNumbers.agu"
...
define i32 @main({} %0) {
entry:
  %call = call i32 @sum(i32 5, i32 5)
  %call1 = call i32 @sum(i32 5, i32 5)
