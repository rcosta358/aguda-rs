; ModuleID = './tests/valid/58185_sequencing/sequencing.agu'
source_filename = "./tests/valid/58185_sequencing/sequencing.agu"
...
define i32 @returnFirst(i32 %0, i32 %1) {
entry:
...
define i32 @returnLast(i32 %0, i32 %1, i32 %2) {
entry:
  %a = alloca i32, align 4
  store i32 %0, ptr %a, align 4
  %b = alloca i32, align 4
...
define i32 @main({} %0) {
entry:
  %call = call i32 @returnFirst(i32 1, i32 2)
  %call1 = call i32 @returnFirst(i32 1, i32 2)
  call void @__print_int__(i32 %call1)
  %call2 = call i32 @returnLast(i32 10, i32 20, i32 30)
  %call3 = call i32 @returnLast(i32 10, i32 20, i32 30)
