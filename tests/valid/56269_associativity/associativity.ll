; ModuleID = './tests/valid/56269_associativity/associativity.agu'
source_filename = "./tests/valid/56269_associativity/associativity.agu"
...
define i32 @main({} %0) {
entry:
  %call = call i32 @assoc({} zeroinitializer)
  %call1 = call i32 @assoc({} zeroinitializer)
