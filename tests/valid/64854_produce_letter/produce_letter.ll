; ModuleID = './tests/valid/64854_produce_letter/produce_letter.agu'
source_filename = "./tests/valid/64854_produce_letter/produce_letter.agu"
...
define i1 @produceLetter(i1 %0) {
entry:
  %letter = alloca i1, align 1
  store i1 %0, ptr %letter, align 1
  %letter1 = load i1, ptr %letter, align 1
  %l = alloca i1, align 1
  store i1 %letter1, ptr %l, align 1
  %l2 = load i1, ptr %l, align 1
  ret i1 %l2
}
...
entry:
  ...
  %call = call i1 @produceLetter(i1 %a1)
  %a2 = load i1, ptr %a, align 1
  %call3 = call i1 @produceLetter(i1 %a2)
