; ModuleID = './tests/valid/tcomp000_letPlusLet/letPlusLet.agu'
source_filename = "./tests/valid/tcomp000_letPlusLet/letPlusLet.agu"
...
entry:
  ...
  store i32 30, ptr %y2, align 4
  %y3 = load i32, ptr %y2, align 4
  %add4 = add i32 %y3, 40
  %add5 = add i32 %add, %add4
  %y6 = alloca i32, align 4
  store i32 10, ptr %y6, align 4
  %y7 = load i32, ptr %y6, align 4
  %add8 = add i32 %y7, 20
  %y9 = alloca i32, align 4
  store i32 30, ptr %y9, align 4
  %y10 = load i32, ptr %y9, align 4
  %add11 = add i32 %y10, 40
  %add12 = add i32 %add8, %add11
  call void @__print_int__(i32 %add12)
  ret i32 0
}
