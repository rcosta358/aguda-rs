; ModuleID = './tests/valid/56311_if_inside_if/if_inside_if.agu'
source_filename = "./tests/valid/56311_if_inside_if/if_inside_if.agu"
...
merge:                                            ; preds = %else, %then
  %phi6 = phi i1 [ true, %then ], [ false, %else ]
  ret i1 %phi6
...
merge3:                                           ; preds = %else2, %then1
  %phi = phi i1 [ true, %then1 ], [ false, %else2 ]
  %if_cond5 = icmp ne i1 %phi, false
  br i1 %if_cond5, label %then, label %else
}

define i32 @main({} %0) {
entry:
  %call = call i1 @func(i32 4)
  %call1 = call i1 @func(i32 4)
  call void @__print_bool__(i1 %call1)
  %call2 = call i1 @func(i32 3)
  %call3 = call i1 @func(i32 3)
