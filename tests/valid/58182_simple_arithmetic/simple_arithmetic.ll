; ModuleID = './tests/valid/58182_simple_arithmetic/simple_arithmetic.agu'
source_filename = "./tests/valid/58182_simple_arithmetic/simple_arithmetic.agu"
...
entry:
  ...
  call void @__print_int__(i32 %sum2)
  %sum3 = load i32, ptr %sum, align 4
  %sum4 = load i32, ptr %sum, align 4
  call void @__print_int__(i32 %sum4)
  %difference = alloca i32, align 4
  store i32 -12, ptr %difference, align 4
  %difference5 = load i32, ptr %difference, align 4
  %difference6 = load i32, ptr %difference, align 4
  call void @__print_int__(i32 %difference6)
  %pow = call i32 @__pow__(i32 5, i32 0)
  %mul = mul i32 4, %pow
  %product = alloca i32, align 4
  store i32 %mul, ptr %product, align 4
  %product7 = load i32, ptr %product, align 4
  %product8 = load i32, ptr %product, align 4
  call void @__print_int__(i32 %product8)
  %div = call i32 @__div__(i32 20, i32 3)
  %quotient = alloca i32, align 4
  store i32 %div, ptr %quotient, align 4
  %quotient9 = load i32, ptr %quotient, align 4
  %quotient10 = load i32, ptr %quotient, align 4
  call void @__print_int__(i32 %quotient10)
  %remainder = alloca i32, align 4
  store i32 0, ptr %remainder, align 4
  %remainder11 = load i32, ptr %remainder, align 4
  %remainder12 = load i32, ptr %remainder, align 4
  call void @__print_int__(i32 %remainder12)
  %pow13 = call i32 @__pow__(i32 2, i32 -2)
  %mul14 = mul i32 8, %pow13
  %div15 = call i32 @__div__(i32 %mul14, i32 2)
  %pow16 = call i32 @__pow__(i32 4, i32 4)
  %mul17 = mul i32 3, %pow16
  %add = add i32 %div15, %mul17
  %complex = alloca i32, align 4
  store i32 %add, ptr %complex, align 4
  %complex18 = load i32, ptr %complex, align 4
  %complex19 = load i32, ptr %complex, align 4
  call void @__print_int__(i32 %complex19)
  ret i32 0
}
