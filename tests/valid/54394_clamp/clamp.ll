; ModuleID = './tests/valid/54394_clamp/clamp.agu'
source_filename = "./tests/valid/54394_clamp/clamp.agu"
...
entry:
  ...
  %gt = icmp sgt i32 %n1, %v2
  %if_cond = icmp ne i1 %gt, false
...
entry:
  ...
  %v3 = load i32, ptr %v, align 4
  %call = call i32 @min(i32 %n2, i32 %v3)
  %call4 = call i32 @max(i32 %m1, i32 %call)
  ret i32 %call4
}

define i32 @main({} %0) {
entry:
  %call = call i32 @clamp(i32 0, i32 7, i32 16)
  %call1 = call i32 @clamp(i32 0, i32 7, i32 16)
