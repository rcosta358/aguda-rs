; ModuleID = './tests/valid/56307_counterFunction/counterFunction.agu'
source_filename = "./tests/valid/56307_counterFunction/counterFunction.agu"
...
define i32 @main({} %0) {
entry:
  %call = call i32 @counterTest(i32 7)
  %call1 = call i32 @counterTest(i32 7)
