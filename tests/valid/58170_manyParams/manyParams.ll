; ModuleID = './tests/valid/58170_manyParams/manyParams.agu'
source_filename = "./tests/valid/58170_manyParams/manyParams.agu"
...
define i32 @manyParams(i32 %0, i32 %1, i32 %2, i32 %3, i32 %4) {
entry:
...
define i32 @main({} %0) {
entry:
  %call = call i32 @manyParams(i32 1, i32 2, i32 3, i32 4, i32 5)
  %call1 = call i32 @manyParams(i32 1, i32 2, i32 3, i32 4, i32 5)
