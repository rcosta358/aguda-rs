; ModuleID = './tests/valid/64361_prime_number/prime_number.agu'
source_filename = "./tests/valid/64361_prime_number/prime_number.agu"
...
merge:                                            ; preds = %after, %then
  %phi12 = phi {} [ zeroinitializer, %then ], [ zeroinitializer, %after ]
  %result13 = load i1, ptr %result, align 1
  ret i1 %result13

cond:                                             ; preds = %merge7, %else
  %i2 = load i32, ptr %i, align 4
  %i3 = load i32, ptr %i, align 4
  %mul = mul i32 %i2, %i3
  %n4 = load i32, ptr %n, align 4
  %leq = icmp sle i32 %mul, %n4
  %while_cond = icmp ne i1 %leq, false
...
body:                                             ; preds = %cond
  ...
  %if_cond10 = icmp ne i1 %eq, false
  br i1 %if_cond10, label %then5, label %else6
...
merge7:                                           ; preds = %else6, %then5
  %phi = phi {} [ zeroinitializer, %then5 ], [ zeroinitializer, %else6 ]
...
define i32 @main({} %0) {
entry:
  %call = call i1 @is_prime(i32 1)
  %call1 = call i1 @is_prime(i32 1)
  call void @__print_bool__(i1 %call1)
  %call2 = call i1 @is_prime(i32 2)
  %call3 = call i1 @is_prime(i32 2)
  call void @__print_bool__(i1 %call3)
  %call4 = call i1 @is_prime(i32 9)
  %call5 = call i1 @is_prime(i32 9)
  call void @__print_bool__(i1 %call5)
  %call6 = call i1 @is_prime(i32 13)
  %call7 = call i1 @is_prime(i32 13)
  call void @__print_bool__(i1 %call7)
  ret i32 0
}
