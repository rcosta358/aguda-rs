; ModuleID = './tests/valid/tcomp000_letOfLet/letOfLet.agu'
source_filename = "./tests/valid/tcomp000_letOfLet/letOfLet.agu"
...
entry:
  ...
  %x67 = alloca {}, align 8
  store {} zeroinitializer, ptr %x67, align 1
  %x68 = load {}, ptr %x67, align 1
  %x69 = load {}, ptr %x67, align 1
  call void @__print_unit__({} %x69)
  ret i32 0
}
