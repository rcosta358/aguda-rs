; ModuleID = './tests/valid/58250_average/58250_average.agu'
source_filename = "./tests/valid/58250_average/58250_average.agu"
...
define i32 @average(i32 %0, i32 %1, i32 %2, i32 %3, i32 %4) {
entry:
  ...
  %add6 = add i32 %add4, %d5
  %e7 = load i32, ptr %e, align 4
  %add8 = add i32 %add6, %e7
  %div = call i32 @__div__(i32 %add8, i32 5)
  ret i32 %div
}

define i32 @result({} %0) {
entry:
  %call = call i32 @average(i32 10, i32 20, i32 30, i32 40, i32 50)
  ret i32 %call
}
...
entry:
  ...
  %call = call i32 @result({} %x1)
  %x2 = load {}, ptr %x, align 1
  %call3 = call i32 @result({} %x2)
