; ModuleID = './tests/valid/58182_function_unit_type/function_unit_type.agu'
source_filename = "./tests/valid/58182_function_unit_type/function_unit_type.agu"
...
define i32 @main({} %0) {
entry:
  %call = call i32 @unitFunction({} zeroinitializer)
