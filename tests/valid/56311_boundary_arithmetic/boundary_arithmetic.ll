; ModuleID = './tests/valid/56311_boundary_arithmetic/boundary_arithmetic.agu'
source_filename = "./tests/valid/56311_boundary_arithmetic/boundary_arithmetic.agu"
...
define i32 @main({} %0) {
entry:
  %minInt = load i32, ptr @minInt, align 4
  %add = add i32 %minInt, 1
  %sub = sub i32 %add, 1
  %minInt1 = load i32, ptr @minInt, align 4
  %add2 = add i32 %minInt1, 1
  %sub3 = sub i32 %add2, 1
  call void @__print_int__(i32 %sub3)
  ret i32 0
}
