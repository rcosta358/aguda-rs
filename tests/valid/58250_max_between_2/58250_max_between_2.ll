; ModuleID = './tests/valid/58250_max_between_2/58250_max_between_2.agu'
source_filename = "./tests/valid/58250_max_between_2/58250_max_between_2.agu"
...
merge:                                            ; preds = %else, %then
  %phi = phi i32 [ %a3, %then ], [ %b4, %else ]
  ret i32 %phi
}

define i32 @main({} %0) {
entry:
  %call = call i32 @max(i32 10, i32 20)
  %call1 = call i32 @max(i32 10, i32 20)
