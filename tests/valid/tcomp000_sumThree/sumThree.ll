; ModuleID = './tests/valid/tcomp000_sumThree/sumThree.agu'
source_filename = "./tests/valid/tcomp000_sumThree/sumThree.agu"
...
define i32 @main({} %0) {
entry:
  %call = call i32 @f(i32 5, i32 6, i32 7)
  %call1 = call i32 @f(i32 5, i32 6, i32 7)
