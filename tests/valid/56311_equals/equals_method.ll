; ModuleID = './tests/valid/56311_equals/equals_method.agu'
source_filename = "./tests/valid/56311_equals/equals_method.agu"
...
entry:
  ...
  %eq = icmp eq i32 %n1, %m2
  ret i1 %eq
}

define i32 @main({} %0) {
entry:
  %call = call i1 @equals(i32 4, i32 5)
  %call1 = call i1 @equals(i32 4, i32 5)
