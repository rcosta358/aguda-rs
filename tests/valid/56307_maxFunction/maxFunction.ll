; ModuleID = './tests/valid/56307_maxFunction/maxFunction.agu'
source_filename = "./tests/valid/56307_maxFunction/maxFunction.agu"
...
entry:
  ...
  %geq = icmp sge i32 %a1, %b2
  %if_cond = icmp ne i1 %geq, false
...
define i32 @main({} %0) {
entry:
  %call = call i32 @max(i32 5, i32 10)
  %call1 = call i32 @max(i32 5, i32 10)
