; ModuleID = './tests/valid/58170_nestedCalls/nestedCalls.agu'
source_filename = "./tests/valid/58170_nestedCalls/nestedCalls.agu"
...
define i32 @main({} %0) {
entry:
  %call = call i32 @h(i32 5)
  %call1 = call i32 @g(i32 %call)
  %call2 = call i32 @f(i32 %call1)
  %call3 = call i32 @h(i32 %call2)
  %call4 = call i32 @g(i32 %call3)
  ...
  call void @__print_int__(i32 %result7)
  ret i32 0
}
