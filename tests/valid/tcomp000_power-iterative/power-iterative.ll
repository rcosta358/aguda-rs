; ModuleID = './tests/valid/tcomp000_power-iterative/power-iterative.agu'
source_filename = "./tests/valid/tcomp000_power-iterative/power-iterative.agu"
...
body:                                             ; preds = %cond
  ...
  %mul = mul i32 %result2, %base3
  store i32 %mul, ptr %result, align 4
  %exponent4 = load i32, ptr %exponent, align 4
  %sub = sub i32 %exponent4, 1
