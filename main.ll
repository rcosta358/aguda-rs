...
define dso_local i32 @__print_int__(i32 noundef %0) #0 {
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @__print_bool__(i32 noundef %0) #0 {
  %2 = alloca i32, align 4
  store i32 %0, ptr %2, align 4
  %3 = load i32, ptr %2, align 4
  %4 = icmp ne i32 %3, 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @__print_unit__() #0 {
...
entry:
  ...
  %pow = call i32 @__pow__(i32 5, i32 2)
  %call = call i32 @__print_int__(i32 %pow)
  ret i32 %call
}
